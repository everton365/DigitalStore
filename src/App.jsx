...
import image4 from "../public/image/imagetenis.png";
import image5 from "../public/image/Group 53582.png";
import image6 from "../public/image/Ornament 11.png";
import image7 from "../public/image/produtos/Frame 9.png";
    ...
    <div className="App">
      <header>
        <section class="container flex">
          <div id="logo">
            ...
            <img className="busca" src={image2} alt="search1" />
          </div>
          <input
            type="text"
            name="nome"
          ...
          <div class="carrinho">
            <img src={image3} alt="logo-carrinho" />
            <span>{cartCount}</span>
          </div>
        </section>
      </header>
      <main>
        <section className="container2 flex2">
          ...
          <button className="btn">Meus Pedidos</button>
        </section>
        ...
        <section className="container5 flex5">
          <div className="product">
            <img id="image" src={image7} alt="sale-off" />
            <h3>
              Novo drop
              <br />
              Supreme
